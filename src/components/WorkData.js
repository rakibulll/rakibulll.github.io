export const Work = [
    {
        id:1,
        name:"Student Research Assistant - Android",
        employer:"Saginaw Valley State University\nComputer Science Department",
        description: "Leveraging an array of research papers and advanced analysis methodologies, I've spearheaded various research initiatives. My endeavors have also encompassed exhaustive literature reviews, particularly focusing on the intriguing domains of Android and sensor data analysis.",
        location: "Saginaw, MI",
    ...
    {
        id:1,
        name:"Research Engineer Intern/Co-op - ML",
        employer:"Magna International\nCorporate R&D",
        description: "Steering a project to optimize image processing, I deployed neural networks on vision-based accelerators, increasing efficiency and accuracy. I've evaluated Systems on a Chip (SoCs) via comprehensive throughput analysis, developed hardware test software, and led real-time image processing projects, deep learning model verification, and data analysis.",
        location: "Troy, MI",
